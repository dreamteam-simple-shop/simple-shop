  ...
  return (
    <button
      ...
      className={`
                ...
                ${isActive ? "bg-black text-white" : "bg-white text-black border border-gray-300 hover:bg-black hover:text-white"}
            `}
    >
      {name}
    </button>
...
export default function Filter({ title }) {
  return (
    <div className="mt-15 md:mt-20 lg:mt-0 flex flex-col gap-8 items-center justify-center">
      ...
      <p className="text-gray-500 text-center max-w-2xl">Discover our handpicked selection of premium products designed to elevate your everyday style.</p>
