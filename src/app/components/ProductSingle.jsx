    ...
    <div className=" px-10  grid md:grid-cols-2 sm:grid-cols-1 gap-12">
      <div className="md:col-1 ">
        <figure className="grid justify-stretch self-center pt-5">
          <Image src={thumbnail} loading="eager" alt="cat" width={400} height={400} className="col-1 row-1 rounded-4xl self-stretch object-cover aspect-square"></Image>
        ...
        <div>
          <div className=" grid gap-2 pb-4">
            ...
            <div className="flex gap-5 items-center">
              <h2 className="text-4xl">$ {discountPercentage > 10 ? price - ((price * discountPercentage) / 100).toFixed(0) : price} </h2>
              <h2 className={`text-2xl text-gray-400 line-through ${discountPercentage > 10 ? "block" : "hidden"}`}>$ {price}</h2>
