...
export default function Hero() {
  return (
    <div className="mt-15 w-full h-[70vh] grid grid-cols-2">
      <div className="col-span-2">
        <Image src="/hero.webp" alt="Hero" loading="eager" width={1920} height={1080} className="w-full sm:h-125 lg:h-150 object-cover filter brightness-80" />
      </div>
